...
public class Kalendar {
    private static final int NUMBER_OF_START_SPACE = 7;

    public static void main(String[] args) {
        StringBuilder varija= new StringBuilder("bla");
        varija.append("asdasd".repeat(5));

        System.out.println(varija);
        // Create Scanner
        ...
        for (int month = 1; month <= 12; month++) {
            ...
            day %= 7;
            for (int b = 0; b <= day * NUMBER_OF_START_SPACE; b++) {
                System.out.print("*");
            }
